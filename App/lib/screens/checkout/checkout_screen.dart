...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  // In a real system: these should come from backend config per restaurant/branch.
  ...
  static Widget _buildPaymentTile(
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: selected ? Icon(Icons.check_circle, color: color.primary) : null,
        onTap: onTap,
      ),
    );
  }
